...
public class Colours
{
    ...
    public static ArrayList<String> colourBoard(ArrayList<String> board)
    {
        ...
        for (String str : board)
        {
            ...
            // colour ray markers
            str =
                str.replaceAll(String.valueOf(rayMarkerReflected), reflectedColour + rayMarkerReflected + boardColour);
            ...
            for (int j = 0; j < pairMarkers.length; j++)
            {
                ...
                {
                    str = str.replace(String.valueOf(pairMarkers[j]),
                                      pairColours[j % pairColours.length] + pairMarkers[j] + boardColour);
                }
            }
            board.set(i, str);
            i++;
