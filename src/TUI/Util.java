...
public class Util {
    ...
    public static void printRayResponse(Ray ray){
        if (ray.getExit() == -1){
            System.out.print("objects.Ray was absorbed!!\n");
        }
        else if(ray.getExit() == ray.getEntry()){
            System.out.print("objects.Ray was reflected back to side " + ray.getEntry() + "\n");
        }
        else{
            System.out.println("objects.Ray exited at "+ ray.getExit());
        }
    }
    ...
    public static void main(String[] args) {
        ...
        if (false) { //example 3
            ...
            rays.add(new Ray(10, box));
               /*for(objects.Ray ray : rays){
            TUI.Util.printRayResponse(ray);
        }*/
            //objects.Atom[] atoms = objects.Atom.generateAtoms(6);
