...
/** This class extends the class objects.Hexagon.java by providing an additional 2 axes for entry from the
 *  outside of the box (marked by two numbered sides).
 */
public class SideHexagon extends Hexagon {
    private int[][] sides;
    /**
     * This constructor generates a new objects.Hexagon and takes :
     *
