...
public class Atom
{
     ...
     */
    public Atom(Coordinate location)
    {
    ...
    {
        if (atoms == null || location == null)
        {
            throw new IllegalArgumentException("passed parameters cannot be null");
        }
        for (Atom atom : atoms)
        {
    ...
    {
        return "Atom("
            + "x:" + (location.x() - 4) + ", y:" + (location.y() - 4) + ", z:" + (location.z() - 4) + ')';
    }
}
