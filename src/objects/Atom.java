...
public class Atom {
    ...
    /**
     * @return a string with stored values of (x,y,z) for an objects.Atom
     */
    @Override
            public String toString() {
                return "objects.Atom(" + "x:" + (location.getX()-4) + ", y:" + (location.getY()-4) + ", z:" + (location.getZ()-4) + ')';
            }

    public static void main(String[] args) {
        //objects.Atom a = new objects.Atom(8,0,4); //TESTING
